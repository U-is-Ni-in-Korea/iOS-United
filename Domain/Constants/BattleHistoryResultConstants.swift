...
public struct BattleHistoryResultConstants {
    public static let battleHistoryResultData = [
    ...
    public static let battleHistoryResultDisconnectedJsonString = """
        {
            "code": "UE1006"
        }
    """
    public static let battleHistoryResultJsonString = """
        [
            {
                "roundGameId": 753,
                "date": "23.12.27",
